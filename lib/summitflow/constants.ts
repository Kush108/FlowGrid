export const OPS_BASE = '/summitflow';

/** Product name — unified ops platform for Summit Heating & Cooling (fictional demo) */
export const APP_NAME = 'SummitFlow Ops';
export const COMPANY_NAME = 'Summit Heating & Cooling';
export const COMPANY_WEBSITE = 'https://flowgrid.ca/summitflow';
...
export const PLATFORM_MODULES = [
  {
    ...
    description: 'Job board, technician routing, open-shift claiming, and zone-based manager views across 6 service areas.',
...
/** Service zone color coding — 6 Edmonton-area zones */
...
export const SESSION_COOKIE = 'summitflow_session';
