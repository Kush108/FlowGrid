...
export const MOCK_SHIFTS: Shift[] = [
  ...
  },
  {
    ...
    siteCode: 'main',
    program: 'group_care',
    title: 'Evening coverage — Group Care',
    location: 'Edmonton Main residence',
    startsAt: `${dayPrefix}T15:00:00`,
    endsAt: `${dayPrefix}T23:00:00`,
    status: 'scheduled',
    requiresVisitLog: true,
    notes: 'Tyler on AM — need PM coverage. Life skills + dinner routine.',
    assignmentType: 'open',
    postedBy: 'Priya N.',
  ...
  },
  {
    ...
    siteCode: 'b',
    program: 'family_living',
    title: 'Weekend home visit — Family Living',
    location: '2311 34 St SE, Edmonton',
    startsAt: `${dayPrefix}T16:00:00`,
    endsAt: `${dayPrefix}T20:00:00`,
    status: 'scheduled',
    requiresVisitLog: true,
    notes: 'Flexible start within 30 min window',
    assignmentType: 'open',
    postedBy: 'Sarah W.',
  ...
  },
  {
    ...
    siteCode: 'f',
    program: 'tap',
    title: 'TAP afternoon session',
    location: 'Central Site — Program room B',
    startsAt: `${dayPrefix}T14:00:00`,
...
export const MOCK_NOTIFICATIONS: OpsNotification[] = [
  ...
  },
  {
    ...
    message: 'Evening Group Care coverage at Edmonton Main — 3 PM to 11 PM. First to claim gets it.',
    type: 'shift',
    createdAt: new Date(Date.now() - 900000).toISOString(),
    read: false,
    href: '/sphinxops/employee/shifts?tab=open',
    siteCode: 'main',
  },
  {
    id: 'n5',
