...
export const MOCK_PROFILES: Profile[] = [
  { id: 'p-dir', fullName: 'Dave S.', email: 'dave@hydroflo.demo', role: 'director', siteId: null },
  { id: 'p-hr', fullName: 'Karen L.', email: 'office@hydroflo.demo', role: 'hr', siteId: null },
  { id: 'p-mgr-main', fullName: 'Mike R.', email: 'mike@hydroflo.demo', role: 'manager', siteId: 's-main', siteCode: 'main' },
  { id: 'p-mgr-b', fullName: 'Lisa K.', email: 'lisa@hydroflo.demo', role: 'manager', siteId: 's-b', siteCode: 'b' },
  { id: 'p-emp-1', fullName: 'Jake T.', email: 'jake@hydroflo.demo', role: 'employee', siteId: 's-main', siteCode: 'main' },
  { id: 'p-emp-2', fullName: 'Marcus B.', email: 'marcus@hydroflo.demo', role: 'employee', siteId: 's-b', siteCode: 'b' },
  { id: 'p-emp-3', fullName: 'Ryan C.', email: 'ryan@hydroflo.demo', role: 'employee', siteId: 's-c', siteCode: 'c' },
];
...
export const MOCK_NOTIFICATIONS: OpsNotification[] = [
  ...
  },
  {
    ...
    read: false,
    href: '/hydroflo/director/reports',
    siteCode: 'b',
  },
  {
    id: 'n4',
  ...
  },
  {
    ...
    read: false,
    href: '/hydroflo/employee/shifts?tab=open',
    siteCode: 'main',
  },
  {
    id: 'n5',
