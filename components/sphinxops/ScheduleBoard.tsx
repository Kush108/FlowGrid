...
import { MOCK_PROFILES, MOCK_SITES } from '@/lib/sphinxops/mock-data';
import { OPS_BASE, PROGRAMS, SITE_COLORS, type SiteCode } from '@/lib/sphinxops/constants';
import { formatDateShort, formatTimeShort, isOpenShift } from '@/lib/sphinxops/shift-utils';
import type { AssignmentType, Profile, Shift } from '@/lib/sphinxops/types';
