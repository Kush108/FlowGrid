...
import { LOGO_PATH, APP_NAME, COMPANY_NAME } from '@/lib/sphinxops/constants';

type SphinxLogoProps = {
  size?: number;
  showText?: boolean;
  className?: string;
};

export function SphinxLogo({ size = 72, showText = true, className = '' }: SphinxLogoProps) {
  return (
